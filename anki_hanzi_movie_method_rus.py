...
class HanziSpacesGenerator:
    ...
    def _build_hanzi_story_prompt(self, hanzi, primary_meaning, actor, location, components):
        ...
        - Она должна легко запоминалась.
        - Опорные слова: иероглиф {hanzi}, значение '{primary_meaning}', актер {actor}, место {location}.
        - Связывай актера, место, компоненты (если есть) и значение иероглифа в короткий сюжет (1-2 предложения).
        ...
        - Размер истории: 1-2 предложения.
        """
